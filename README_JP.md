...
- [release-aware-upgrade](./tasks/setup/release-aware-upgrade/README_JP.md) — アプリ内バナーが ClawMaster の新リリースを通知、設定ページでリリースノートを読み、OS に合ったインストーラーをワンクリックで入手
...
- [wiki-ingest-to-synthesis](./tasks/save/wiki-ingest-to-synthesis/README_JP.md) — 数本の Markdown を Wiki に投入、自動タグ付けと相互リンクを確認、跨ソース質問の回答をワンクリックでシンセシスページとして固化、進化を実行して Wiki に自己点検させる
